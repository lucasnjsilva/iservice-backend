...
export function responseSuccess(response: ResponseContract, data?: any) {
...
export function responsePagination(response: ResponseContract, data: any) {
...
export function responseAppError(response: ResponseContract, error: AppError) {
...
export function responseError(
  ...
  if (code instanceof AppError) {
    responseAppError(response, code);
    return;
